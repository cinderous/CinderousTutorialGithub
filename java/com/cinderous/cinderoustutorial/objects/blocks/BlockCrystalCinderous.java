...
public class BlockCrystalCinderous extends Block implements IPlantable {

    public static final PropertyInteger AGE = PropertyInteger.create("age", 0, 15);
    protected static final AxisAlignedBB CRYSTAL_COLLISION_AABB = new AxisAlignedBB(0.0625D, 0.0D, 0.0625D, 0.9375D, 0.9375D, 0.9375D);
    protected static final AxisAlignedBB CRYSTAL_AABB = new AxisAlignedBB(0.0625D, 0.0D, 0.0625D, 0.9375D, 1.0D, 0.9375D);
	
	public BlockCrystalCinderous(String name) {
...
/*
	...
	public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
		return BlockInit.BLOCK_CRYSTAL_CINDEROUS.getDefaultState();
	}
	...
	//so things dont connect to the block like glass panes
